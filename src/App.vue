<template>
    <div id="app">
        ...
        <div id="content">
            ...
            <add-layout
                :layout.sync="addLayout"
                :toLayout.sync="layout"
            >
                <add-item
                    v-for="(item, index) in addLayout"
                    :key="index"
                    :clone="true"
                    :i="item.i"
                    :w="2"
...
import AddLayout from './components/AddLayout.vue';
